...
python scripts/singbox-remote-generate.py "https://clash2sfa.xmdhs.com/sub?sub=https://suo.st/E2VJf4t" ../singbox/skr.json
...
python scripts/singbox-remote-generate.py "https://clash2sfa.xmdhs.com/sub?sub=https://raw.githubusercontent.com/voidlhf/Sub/refs/heads/branch1/mihomo/matefox.yaml" ../singbox/matefox.json
